...
## 2026-05-08: Seed 1 hit the fourth validation/checkpoint milestone at step 4000.

**Run and milestone evidence**

- active run: `main-001-attention_only-seed-1`
- retained validation row at step `4000` in `artifacts/results/main-001-attention_only-seed-1/metrics.jsonl`
- printed runner line in `tmux` window `#4`: `main-001-attention_only-seed-1: validation step=4000 nll=0.338706`

**Numbers**

- validation metric: `validation_mean_nll = 0.3387062138585547`
- checkpoint path: `tinker://0a1ef6bf-6503-5550-95da-db41f4e3a710:train:1/weights/main-001-attention_only-seed-1-step-4000`
- validation token count on this milestone row: `936583`
- milestone row `cost`: `null` (no per-row cost telemetry yet)
...
- step `4000` was followed by the validation/checkpoint block, then training resumed
- latest observed optimizer step after this milestone: `4074`

**Next**

Resume 15-minute cadence monitoring on seed 1 and watch for milestones at steps `5000`, `6000`, and `6338`.

## 2026-05-08: Seed 1 hit the fifth validation/checkpoint milestone at step 5000.

**Run and milestone evidence**

- active run: `main-001-attention_only-seed-1`
- retained validation row at step `5000` in `artifacts/results/main-001-attention_only-seed-1/metrics.jsonl`
- printed runner line in `tmux` window `#4`: `main-001-attention_only-seed-1: validation step=5000 nll=0.337975`

**Numbers**

- validation metric: `validation_mean_nll = 0.3379754202999871`
- checkpoint path: `tinker://0a1ef6bf-6503-5550-95da-db41f4e3a710:train:1/weights/main-001-attention_only-seed-1-step-5000`
- validation token count on this milestone row: `936583`
- milestone row `cost`: `null` (no per-row cost telemetry yet)
...
- step `5000` was followed by the validation/checkpoint block, then training resumed
- latest observed optimizer step after this milestone: `5185`

**Next**

Resume 15-minute cadence monitoring on seed 1 and watch for milestones at steps `6000` and `6338`.

## 2026-05-08: Seed 1 hit the sixth validation/checkpoint milestone at step 6000.

**Run and milestone evidence**

- active run: `main-001-attention_only-seed-1`
- retained validation row at step `6000` in `artifacts/results/main-001-attention_only-seed-1/metrics.jsonl`
- printed runner line in `tmux` window `#4`: `main-001-attention_only-seed-1: validation step=6000 nll=0.337561`

**Numbers**

- validation metric: `validation_mean_nll = 0.33756054030574645`
- checkpoint path: `tinker://0a1ef6bf-6503-5550-95da-db41f4e3a710:train:1/weights/main-001-attention_only-seed-1-step-6000`
- validation token count on this milestone row: `936583`
- milestone row `cost`: `null` (no per-row cost telemetry yet)
...
- step `6000` was followed by the validation/checkpoint block, then training resumed
- latest observed optimizer step after this milestone: `6056`
...
## 2026-05-08: Seed 2 hit the first validation/checkpoint milestone at step 1000.

**Run and milestone evidence**

- active run: `main-001-attention_only-seed-2`
- retained validation row at step `1000` in `artifacts/results/main-001-attention_only-seed-2/metrics.jsonl`
- printed runner line in `tmux` window `#4`: `main-001-attention_only-seed-2: validation step=1000 nll=0.346536`

**Numbers**

- validation metric: `validation_mean_nll = 0.34653612333243416`
- checkpoint path: `tinker://0a1ef6bf-6503-5550-95da-db41f4e3a710:train:2/weights/main-001-attention_only-seed-2-step-1000`
- validation token count on this milestone row: `936583`
- milestone row `cost`: `null` (no per-row cost telemetry yet)
...
- step `1000` was followed by the validation/checkpoint block, then training resumed
- latest observed optimizer step after this milestone: `1144`

**Next**

Resume 15-minute cadence monitoring on seed 2 and watch for milestones at steps `2000`, `3169`, `4000`, `5000`, `6000`, and `6338`.

## 2026-05-08: Seed 2 hit the second validation/checkpoint milestone at step 2000.

**Run and milestone evidence**

- active run: `main-001-attention_only-seed-2`
- retained validation row at step `2000` in `artifacts/results/main-001-attention_only-seed-2/metrics.jsonl`
- printed runner line in `tmux` window `#4`: `main-001-attention_only-seed-2: validation step=2000 nll=0.341494`

**Numbers**

- validation metric: `validation_mean_nll = 0.34149399717505874`
- checkpoint path: `tinker://0a1ef6bf-6503-5550-95da-db41f4e3a710:train:2/weights/main-001-attention_only-seed-2-step-2000`
- validation token count on this milestone row: `936583`
- milestone row `cost`: `null` (no per-row cost telemetry yet)

**Observed timing behavior**

- step `2000` train/optim rows were followed by a delayed validation/checkpoint row, then training resumed
- latest observed optimizer step after this milestone: `2081`

**Next**

Resume 15-minute cadence monitoring on seed 2 and watch for milestones at steps `3169`, `4000`, `5000`, `6000`, and `6338`.

## 2026-05-08: Seed 2 hit the third validation/checkpoint milestone at step 3169.

**Run and milestone evidence**

- active run: `main-001-attention_only-seed-2`
- retained validation row at step `3169` in `artifacts/results/main-001-attention_only-seed-2/metrics.jsonl`
- printed runner line in `tmux` window `#4`: `main-001-attention_only-seed-2: validation step=3169 nll=0.336510`

**Numbers**

- validation metric: `validation_mean_nll = 0.33651007850933906`
- checkpoint path: `tinker://0a1ef6bf-6503-5550-95da-db41f4e3a710:train:2/weights/main-001-attention_only-seed-2-step-3169`
- validation token count on this milestone row: `936583`
- milestone row `cost`: `null` (no per-row cost telemetry yet)

**Observed timing behavior**

- step `3169` train/optim rows were followed by a delayed validation/checkpoint row, then training resumed
- latest observed optimizer step after this milestone: `3247`

**Next**

Resume 15-minute cadence monitoring on seed 2 and watch for milestones at steps `4000`, `5000`, `6000`, and `6338`.

## 2026-05-08: Seed 2 hit the fourth validation/checkpoint milestone at step 4000.

**Run and milestone evidence**

- active run: `main-001-attention_only-seed-2`
- retained validation row at step `4000` in `artifacts/results/main-001-attention_only-seed-2/metrics.jsonl`
- printed runner line in `tmux` window `#4`: `main-001-attention_only-seed-2: validation step=4000 nll=0.338329`

**Numbers**

- validation metric: `validation_mean_nll = 0.3383288403931016`
- checkpoint path: `tinker://0a1ef6bf-6503-5550-95da-db41f4e3a710:train:2/weights/main-001-attention_only-seed-2-step-4000`
- validation token count on this milestone row: `936583`
- milestone row `cost`: `null` (no per-row cost telemetry yet)

**Observed timing behavior**

- step `4000` train/optim rows were followed by a delayed validation/checkpoint row, then training resumed
- latest observed optimizer step after this milestone: `4010`
...
## 2026-05-08: Seed 2 hit the sixth validation/checkpoint milestone at step 6000.

**Run and milestone evidence**

- active run: `main-001-attention_only-seed-2`
- retained validation row at step `6000` in `artifacts/results/main-001-attention_only-seed-2/metrics.jsonl`
- printed runner line in `tmux` window `#4`: `main-001-attention_only-seed-2: validation step=6000 nll=0.337282`

**Numbers**

- validation metric: `validation_mean_nll = 0.33728229576529856`
- checkpoint path: `tinker://0a1ef6bf-6503-5550-95da-db41f4e3a710:train:2/weights/main-001-attention_only-seed-2-step-6000`
- validation token count on this milestone row: `936583`
- milestone row `cost`: `null` (no per-row cost telemetry yet)

**Observed timing behavior**

- step `6000` train/optim rows were followed by a delayed validation/checkpoint row, then training resumed
- latest observed optimizer step after this milestone: `6045`

**Next**

Resume 15-minute cadence monitoring on seed 2 and watch for the final step `6338` milestone and run completion artifacts.

## 2026-05-08: Completed `main-001-attention_only-seed-2` and started `main-001-all_layer-seed-0`.

**Run completion evidence for seed 2**

- `tmux` window `#4` printed: `main-001-attention_only-seed-2: validation step=6338 nll=0.336658`
- completion artifacts now exist in `artifacts/results/main-001-attention_only-seed-2/`: `manifest.json`, `metrics.jsonl`, `sample_render.txt`, `summary.json`
- `artifacts/results/main-001-attention_only-seed-2/manifest.json` now reports `status: pass`
- `artifacts/results/main-001-attention_only-seed-2/summary.json` now reports `status: pass`

**Final milestone and selection numbers (seed 2)**

- final-step validation row (`step 6338`) `validation_mean_nll = 0.3366583420042444`
- final-step checkpoint path: `tinker://0a1ef6bf-6503-5550-95da-db41f4e3a710:train:2/weights/main-001-attention_only-seed-2-step-6338`
- selected best validation step from summary: `3169`
- selected checkpoint path from summary: `tinker://0a1ef6bf-6503-5550-95da-db41f4e3a710:train:2/weights/main-001-attention_only-seed-2-step-3169`
- selected primary metric from summary: `validation_mean_nll = 0.33651007850933906`
- summary token counts: train `17227430`, validation `6556081`, total `23783511`

**Next run start evidence (all-layer seed 0)**

- `tmux` window `#4` printed: `starting main-001-all_layer-seed-0: condition=all_layer seed=0`
- `artifacts/results/main-001-all_layer-seed-0/manifest.json` now reports `status: started`
- first progress snapshot for all-layer seed 0: `metrics.jsonl` currently has `2` lines, latest `main_optim` row at `step 1`

**Next**

Continue 15-minute cadence monitoring on `main-001-all_layer-seed-0` and log milestones at steps `1000`, `2000`, `3169`, `4000`, `5000`, `6000`, and `6338`.

## 2026-05-08: All-layer seed 0 hit the first validation/checkpoint milestone at step 1000.

**Run and milestone evidence**

- active run: `main-001-all_layer-seed-0`
- retained validation row at step `1000` in `artifacts/results/main-001-all_layer-seed-0/metrics.jsonl`
- printed runner line in `tmux` window `#4`: `main-001-all_layer-seed-0: validation step=1000 nll=0.345928`

**Numbers**

- validation metric: `validation_mean_nll = 0.3459276755590434`
- checkpoint path: `tinker://0a1ef6bf-6503-5550-95da-db41f4e3a710:train:3/weights/main-001-all_layer-seed-0-step-1000`
- validation token count on this milestone row: `936583`
- milestone row `cost`: `null` (no per-row cost telemetry yet)

**Observed timing behavior**

- step `1000` train/optim rows were followed by a delayed validation/checkpoint row, then training resumed
- latest observed optimizer step after this milestone: `1050`

**Next**

Resume 15-minute cadence monitoring on all-layer seed 0 and watch for milestones at steps `2000`, `3169`, `4000`, `5000`, `6000`, and `6338`.

## 2026-05-08: All-layer seed 0 hit the second validation/checkpoint milestone at step 2000.

**Run and milestone evidence**

- active run: `main-001-all_layer-seed-0`
- retained validation row at step `2000` in `artifacts/results/main-001-all_layer-seed-0/metrics.jsonl`
- printed runner line in `tmux` window `#4`: `main-001-all_layer-seed-0: validation step=2000 nll=0.342183`

**Numbers**

- validation metric: `validation_mean_nll = 0.342182684437154`
- checkpoint path: `tinker://0a1ef6bf-6503-5550-95da-db41f4e3a710:train:3/weights/main-001-all_layer-seed-0-step-2000`
- validation token count on this milestone row: `936583`
- milestone row `cost`: `null` (no per-row cost telemetry yet)
...
- step `2000` train/optim rows were followed by a delayed validation/checkpoint row, then training resumed
- latest observed optimizer step after this milestone: `2046`
...
## 2026-05-08: All-layer seed 0 hit the fourth validation/checkpoint milestone at step 4000.

**Run and milestone evidence**

- active run: `main-001-all_layer-seed-0`
- retained validation row at step `4000` in `artifacts/results/main-001-all_layer-seed-0/metrics.jsonl`
- printed runner line in `tmux` window `#4`: `main-001-all_layer-seed-0: validation step=4000 nll=0.3456`

**Numbers**

- validation metric: `validation_mean_nll = 0.3456637918063231`
- checkpoint path: `tinker://0a1ef6bf-6503-5550-95da-db41f4e3a710:train:3/weights/main-001-all_layer-seed-0-step-4000`
- validation token count on this milestone row: `936583`
- milestone row `cost`: `null` (no per-row cost telemetry yet)

**Observed timing behavior**

- step `4000` train/optim rows appeared first, followed by a delayed validation/checkpoint row, then training resumed
- latest observed optimizer step after this milestone: `4223`

**Next**

Resume 15-minute cadence monitoring on all-layer seed 0 and watch for milestones at steps `5000`, `6000`, and `6338`.

## 2026-05-08: All-layer seed 0 hit the fifth validation/checkpoint milestone at step 5000.

**Run and milestone evidence**

- active run: `main-001-all_layer-seed-0`
- retained validation row at step `5000` in `artifacts/results/main-001-all_layer-seed-0/metrics.jsonl`
- printed runner line in `tmux` window `#4`: `main-001-all_layer-seed-0: validation step=5000 nll=0.346560`

**Numbers**

- validation metric: `validation_mean_nll = 0.34656007143092127`
- checkpoint path: `tinker://0a1ef6bf-6503-5550-95da-db41f4e3a710:train:3/weights/main-001-all_layer-seed-0-step-5000`
- validation token count on this milestone row: `936583`
- milestone row `cost`: `null` (no per-row cost telemetry yet)

**Observed timing behavior**

- step `5000` train/optim rows appeared first, followed by a delayed validation/checkpoint row, then training resumed
- latest observed optimizer step after this milestone: `5074`

**Next**

Resume 15-minute cadence monitoring on all-layer seed 0 and watch for milestones at steps `6000` and `6338`.

## 2026-05-08: All-layer seed 0 hit the sixth validation/checkpoint milestone at step 6000.

**Run and milestone evidence**

- active run: `main-001-all_layer-seed-0`
- retained validation row at step `6000` in `artifacts/results/main-001-all_layer-seed-0/metrics.jsonl`
- printed runner line in `tmux` window `#4`: `main-001-all_layer-seed-0: validation step=6000 nll=0.347171`

**Numbers**

- validation metric: `validation_mean_nll = 0.34717140110659017`
- checkpoint path: `tinker://0a1ef6bf-6503-5550-95da-db41f4e3a710:train:3/weights/main-001-all_layer-seed-0-step-6000`
- validation token count on this milestone row: `936583`
- milestone row `cost`: `null` (no per-row cost telemetry yet)

**Observed timing behavior**

- step `6000` train/optim rows appeared first, followed by a delayed validation/checkpoint row, then training resumed
- latest observed optimizer step after this milestone: `6007`
...
## 2026-05-09: All-layer seed 1 hit the second validation/checkpoint milestone at step 2000.

**Run and milestone evidence**

- active run: `main-001-all_layer-seed-1`
- retained validation row at step `2000` in `artifacts/results/main-001-all_layer-seed-1/metrics.jsonl`
- printed runner line in `tmux` window `#4`: `main-001-all_layer-seed-1: validation step=2000 nll=0.341776`

**Numbers**

- validation metric: `validation_mean_nll = 0.3417758140564665`
- checkpoint path: `tinker://0a1ef6bf-6503-5550-95da-db41f4e3a710:train:4/weights/main-001-all_layer-seed-1-step-2000`
- validation token count on this milestone row: `936583`

**Cross-condition reference at step 2000**
...
- `all_layer-seed-1`: `0.3417758140564665` — between seed-0 and the attention_only band
...
## 2026-05-09: All-layer seed 1 hit the fifth validation/checkpoint milestone at step 5000.

**Run and milestone evidence**

- active run: `main-001-all_layer-seed-1`
- retained validation row at step `5000` in `artifacts/results/main-001-all_layer-seed-1/metrics.jsonl`
- printed runner line in `tmux` window `#4`: `main-001-all_layer-seed-1: validation step=5000 nll=0.346607`

**Numbers**

- validation metric: `validation_mean_nll = 0.34660669579029896`
- checkpoint path: `tinker://0a1ef6bf-6503-5550-95da-db41f4e3a710:train:4/weights/main-001-all_layer-seed-1-step-5000`
- validation token count on this milestone row: `936583`
...
- `all_layer-seed-1`: `0.34660669579029896` — both all_layer seeds remain ~`0.009` worse than the attention_only band at step `5000`, but step-`3169` is the selected checkpoint for both, so this does not affect the final comparison
...
## 2026-05-09: All-layer seed 2 hit the first validation/checkpoint milestone at step 1000.

**Run and milestone evidence**

- active run: `main-001-all_layer-seed-2`
- retained validation row at step `1000` in `artifacts/results/main-001-all_layer-seed-2/metrics.jsonl`
- printed runner line in `tmux` window `#4`: `main-001-all_layer-seed-2: validation step=1000 nll=0.346093`

**Numbers**

- validation metric: `validation_mean_nll = 0.34609265838650455`
- checkpoint path: `tinker://0a1ef6bf-6503-5550-95da-db41f4e3a710:train:5/weights/main-001-all_layer-seed-2-step-1000`
- validation token count on this milestone row: `936583`

**Cross-condition reference at step 1000 (all six runs)**

- `attention_only-seed-0`: `0.3468661579136847`
- `attention_only-seed-1`: `0.3467035731733388`
- `attention_only-seed-2`: `0.34653612333243416`
- `all_layer-seed-0`: `0.3459276755590434`
- `all_layer-seed-1`: `0.34568629786299837`
- `all_layer-seed-2`: `0.34609265838650455` — all three all_layer seeds spread `0.34569–0.34609`, every all_layer seed is at or below every attention_only seed at step 1000
...
## 2026-05-09: All-layer seed 2 hit the fourth validation/checkpoint milestone at step 4000.

**Run and milestone evidence**

- active run: `main-001-all_layer-seed-2`
- retained validation row at step `4000` in `artifacts/results/main-001-all_layer-seed-2/metrics.jsonl`
- printed runner line in `tmux` window `#4`: `main-001-all_layer-seed-2: validation step=4000 nll=0.346158`

**Numbers**

- validation metric: `validation_mean_nll = 0.3461580484910246`
- checkpoint path: `tinker://0a1ef6bf-6503-5550-95da-db41f4e3a710:train:5/weights/main-001-all_layer-seed-2-step-4000`
- validation token count on this milestone row: `936583`

**Within-seed behavior**

- step `3169 → 4000` NLL: `0.33634 → 0.34616` (delta `+0.00982`)
- matches the pattern seen in the other two all_layer seeds (deltas `+0.00955` and `+0.00894`); all three all_layer seeds show a `~0.009`–`0.010` bounce-up at step `4000`, vs `~0.0018`–`0.0029` for attention_only at the same checkpoint
- step `3169` remains the current best for all_layer seed 2 by the same wide margin
...
## 2026-05-10: Built the phase 13 figure pipeline (eight derived artifacts)

- Built `figures/helpers.py` (palette, marker, linestyle constants, `set_paper_style`, JSON/JSONL readers, SHA-256 hasher, run-directory finders, Markdown-table renderer, save helpers, provenance writer) and eight `figures/fig_NN_<name>.py` deliverables under the orchestrator pattern locked in TODO section 13.
- Outputs land under `artifacts/figures/<fig_name>/` with the retained file set: tables emit `<name>.md` + `<name>.data.csv` + `<name>.provenance.json`; charts additionally emit `<name>.pdf` + `<name>.png` + `<name>.grayscale.png`. Captions are paper-style (no internal repo paths in the caption text) and live in each figure's `<name>.md` plus inline in TODO section 13's build order so the planning text and the rendered text are in sync.
- Numbers were verified against retained sources for every figure before each was marked done:
  - fig_01 / fig_02 / fig_03: per-condition mean/min/max/delta against the canonical six `summary.json` files and the `comparison.md` aggregate (attention_only mean `0.9054839524892596`, all_layer mean `0.9009350518069245`).
  - fig_04 / fig_07: paired predictions joined by `benchmark_index`; per-seed contingency `(att_only, all_only, both_correct, both_wrong)` confirmed equal to `comparison.md` and summed to `1319` per seed (the runtime check raises if it does not).
  - fig_05: validation NLL at step `3169` reads `0.3361636318`, `0.3362120226`, `0.3365100785` (attention_only seeds 0/1/2) and `0.3361193801`, `0.3365558372`, `0.3363413165` (all_layer seeds 0/1/2), matching the `0.3361–0.3366` cluster recorded in the 2026-05-09 sweep entry.
  - fig_06: small-slice LR-selection NLLs at the selected `3e-4` are `0.3633` (attention_only) and `0.3560` (all_layer); both conditions' minima fall on `3e-4`, matching the locked main-run protocol selection.
  - fig_08: seconds per optimizer step at effective batch size `8` for `attention_only`: single-datum `20.22`, batched `5.20`, batched-pipelined `2.41`. Pipelined delivers an `8.4×` speedup over single-datum sequential.
- Provenance JSONs record the input file SHA-256 hashes plus the git commit at build time. Spot-check on fig_04 and fig_07 confirmed all six `predictions.jsonl` input hashes match the current bytes.
- Accessibility: every chart passes a grayscale render check; condition identity is recoverable via marker shape (diamond/circle/square) and line style without relying on color alone.
- Iteration notes worth retaining for future viz work: fig_03 went through three rounds before landing — first as bar+line with horizontal baseline reference, then as three-position dot/range with x-axis labels, finally as three-position diamond+circle+square with hidden x-axis ticks (legend is sole identifier). User pushbacks during iteration ("redundant labels", "looks like a time-series threshold", "captions reference internal repo paths") each caught real design issues.

## 2026-05-10: Pivoted fig_04 from a slope/delta view to per-seed prediction-disagreement small-multiples

- Original fig_04 design (paired-seed slope plot showing net correct-count delta `+7/+6/+5`) was rejected through six iterations: vertical slope, leader labels, corner text-boxes, horizontal dumbbell, vertical paired columns, delta-only bar chart. Recurring failure modes: directional progression reading, ambiguous seed identity, unit collision between accuracy axis and count delta, and visual overweight of the small `0.4–0.5 pp` net effect.
- Solicited two independent agent reviews (Kimi 2.6 and DeepSeek V4 Pro). Kimi proposed a vertical paired dot plot with bracketed deltas; DeepSeek proposed a per-seed disagreement small-multiples plot. DeepSeek's framing reframed the question from "what is the net delta?" to "what is the per-seed disagreement structure?" — a richer, more falsifiable claim that does not duplicate fig_03 (net accuracy) or rely on a y-axis fine enough to resolve `0.4–0.5 pp`.
- New fig_04 design: three panels (one per seed); per panel, two bars — `attention_only_only` (blue solid, examples where attention-only is correct and all-layer is wrong) and `all_layer_only` (orange diagonal-hatched, the reverse). Both-right and both-wrong agreement counts shown as small-grey annotation under each panel. No connecting elements between bars; seed identity anchored by panel titles. Hatching on the orange bar provides the grayscale-fallback marker.
- Pre-implementation number verification by re-running the contingency join against the six retained `predictions.jsonl` files: seed 0 `(att_only_only=54, all_layer_only=47, both_correct=1139, both_wrong=79)`, seed 1 `(49, 43, 1147, 80)`, seed 2 `(46, 41, 1148, 84)`. All three seed totals equal `1319`; disagreement deltas `+7/+6/+5` match the original headline. Filename and `FIG_NAME` retained as `fig_04_paired_seed_slope` so existing artifact paths and provenance hashes do not move; the chart itself is the small-multiples described above. TODO section 13 line 04 description and caption updated to match.
- Pairs with fig_07 (full per-seed contingency table). Mild redundancy is intentional: chart shows the asymmetry visually, table provides exhaustive numbers and the agreement region the chart annotates only as text.
